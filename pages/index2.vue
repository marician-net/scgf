  ...
  <div class="flex justify-center w-full flex-wrap pt-40 lg:pt-64">
    ...
    <main class="w-full z-10 relative lg:mt-20">
      <div class="mx-auto text-center">
        ...
        <s-card-line3 class="card-line-3" />

        <img class="crystal" src="/il/_crystal.png" alt="Crystal" />
        <img class="crystal-1" src="/il/_crystal-1.png" alt="Crystal" />
      ...
      <div class="w-full lg:w-4/5 mx-auto mt-10 lg:mt-40">
        <div class="flex w-full flex-wrap">
          ...
          <lottie-player class="w-full" src="https://assets3.lottiefiles.com/private_files/lf30_iakk850x.json" 
